...
const VideoTitle = ({title,overview}) => {
  ...
  return (
   ...
   <div className=''>
       <button className='bg-white p-2 px-14 mx-2  rounded-md text-xl text-slate-900 hover:bg-opacity-60' onClick={videoPlay}><FontAwesomeIcon icon={faPlay} /> Play</button>
